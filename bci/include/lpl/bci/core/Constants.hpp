...
inline constexpr float kFrequencyResolution = kDefaultSampleRate / static_cast<float>(kDefaultFftSize);
 ...
 */
inline constexpr float kCytonScaleFactor = 4.5f / 24.0f / 8388607.0f * 1000000.0f;
