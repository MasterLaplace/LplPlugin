...
-- -- local package repository stored in workspace (contains liblsl & brainflow recipes)
-- add_repositories("package_repo /home/masterlaplace/LplPlugin/xmake-repo")
-- -- remote fallback in case local copy is missing or outdated
