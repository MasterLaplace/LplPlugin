...
GpuBuffer::GpuBuffer(IComputeBackend &backend, core::usize bytes) : _backend{&backend}, _size{bytes}
{
...
GpuBuffer::GpuBuffer(GpuBuffer &&other) noexcept
    : _backend{std::exchange(other._backend, nullptr)}, _ptr{std::exchange(other._ptr, nullptr)},
