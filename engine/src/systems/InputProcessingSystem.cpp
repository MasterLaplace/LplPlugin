...
static const ecs::SystemDescriptor kInputProcessingDesc{
    "InputProcessing",
...
struct InputProcessingSystem::Impl
{
    ...
    Impl(EventQueues& q, input::InputManager& im)
        : queues{q}, inputManager{im}
    {
    }
};
...
InputProcessingSystem::InputProcessingSystem(EventQueues& queues,
                                             input::InputManager& inputManager)
...
const ecs::SystemDescriptor& InputProcessingSystem::descriptor() const noexcept
{
    return kInputProcessingDesc;
}
