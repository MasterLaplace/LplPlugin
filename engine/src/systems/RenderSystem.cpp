...
static const ecs::SystemDescriptor kRenderSystemDesc{"RenderSystem", ecs::SchedulePhase::Render,
...
RenderSystem::RenderSystem(ecs::Registry &registry, render::IRenderer *renderer)
    : _registry(registry), _renderer(renderer)
{
}

const ecs::SystemDescriptor &RenderSystem::descriptor() const noexcept { return kRenderSystemDesc; }
