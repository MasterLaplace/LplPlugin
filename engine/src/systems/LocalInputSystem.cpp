...
static const ecs::SystemDescriptor kLocalInputSystemDesc{
    "LocalInputSystem",
    ecs::SchedulePhase::Input,
    {}
};

LocalInputSystem::LocalInputSystem(input::InputManager& inputManager,
                                   GLFWwindow* window,
...
const ecs::SystemDescriptor& LocalInputSystem::descriptor() const noexcept
{
    return kLocalInputSystemDesc;
}
