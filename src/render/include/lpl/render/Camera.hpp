...
public:
    ...
    [[nodiscard]] const math::Vec3<core::f32>& position() const noexcept { return position_; }
    [[nodiscard]] const math::Quat<core::f32>& orientation() const noexcept { return orientation_; }

private:
    math::Vec3<core::f32>  position_{};
    math::Quat<core::f32>  orientation_{};
    core::f32              fov_{1.0472f};
    core::f32              aspect_{16.0f / 9.0f};
    core::f32              nearPlane_{0.1f};
    core::f32              farPlane_{1000.0f};
};
