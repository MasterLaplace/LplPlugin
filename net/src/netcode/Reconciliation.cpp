...
Reconciliation::Reconciliation(Prediction &prediction) : _prediction{prediction} {}

Reconciliation::~Reconciliation() = default;

core::Expected<void> Reconciliation::reconcile(std::span<const core::byte> authoritativeState, core::u32 ackedSequence,
                                               core::f32 dt,
